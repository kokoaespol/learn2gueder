...
var $author$project$Model$Todo$Todo = F3(
	function (id, content, completed) {
		return {completed: completed, content: content, id: id};
	});
...
var $author$project$Model$Todo$decode = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Model$Todo$Todo,
...
var $author$project$Api$Todo$getAll = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$Msg$GotTodos,
			$elm$json$Json$Decode$list($author$project$Model$Todo$decode)),
		url: '/todos'
	});
...
var $author$project$Msg$CompletedTodo = F3(
	function (a, b, c) {
		return {$: 'CompletedTodo', a: a, b: b, c: c};
	});
...
var $author$project$Api$Todo$complete = F2(
	function (todoId, completed) {
		return $elm$http$Http$request(
			{
				...
				expect: $elm$http$Http$expectWhatever(
					A2($author$project$Msg$CompletedTodo, todoId, completed)),
				headers: _List_Nil,
				method: 'PATCH',
...
var $author$project$Msg$CreatedTodo = function (a) {
...
var $author$project$Api$Todo$create = function (content) {
	return $elm$http$Http$post(
		{
			...
			expect: A2($elm$http$Http$expectJson, $author$project$Msg$CreatedTodo, $author$project$Model$Todo$decode),
			url: '/todos'
		});
};
var $author$project$Msg$DeletedTodo = F2(
	function (a, b) {
		return {$: 'DeletedTodo', a: a, b: b};
	});
var $author$project$Api$Todo$delete = function (todoId) {
	return $elm$http$Http$request(
		{
			body: $elm$http$Http$emptyBody,
			expect: $elm$http$Http$expectWhatever(
				$author$project$Msg$DeletedTodo(todoId)),
			headers: _List_Nil,
			method: 'DELETE',
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			...
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2(
						'error-msg',
						$author$project$Main$isJust(errMsg))
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$Msg$CompleteTodo = F2(
	function (a, b) {
		return {$: 'CompleteTodo', a: a, b: b};
	});
var $author$project$Msg$DeleteTodo = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('create-todo')
					]),
				_List_fromArray(
					[
						A2(
